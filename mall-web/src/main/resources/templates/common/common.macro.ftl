	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="nav-click <#if pageName == "order">active</#if>" ><a href="${request.contextPath}/order"><i class="fa fa-circle-o text-purple"></i><span>订单管理</span></a></li>
	...
	<footer class="main-footer">
		...
		<div class="pull-right hidden-xs">
            <strong>Copyright &copy; 2015-${.now?string('yyyy')} &nbsp;
                <a href="https://www.xuxueli.com/" target="_blank" >wgp</a>
				&nbsp;
