...
import com.wgp.mall.gayteway.filter.AuthorizeGatewayFilterFactory.Config;
...
@Component
@Slf4j
public class AuthorizeGatewayFilterFactory extends AbstractGatewayFilterFactory<Config> {
